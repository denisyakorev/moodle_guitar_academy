...
This document describes how to copy and customise the guitaracademy (bootstrapbase) theme so that
...
From your Moodle theme directory right click on guitaracademy and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of guitaracademy.
...
underscores. For the purpose of this tutorial we will call the theme 'guitaracademytheme'.

On opening 'guitaracademytheme' your you will find several files and sub-directories which have
files within them.
...
/lang/en/theme_guitaracademy.php
...
where the old theme name occurs, in this case guitaracademy. So using the above list as
a guide, search through and change all the instances of the theme name
'guitaracademy' to 'guitaracademytheme'. This includes the filename of the lang/en/theme_guitaracademy.php.
You need to change this to 'theme_guitaracademytheme.php'.
...
and then click on (guitaracademytheme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the guitaracademy theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > guitaracademy

Moodle documentation
--------------------

Further information can be found on Moodle Docs: http://docs.moodle.org/dev/guitaracademy_theme
